...
cap log close
log using complex_noint_mar1_2, smcl replace
...
tempname sim
postfile `sim' int(rep) str28(method) float(mcra mderiv b0 btrt se0 setrt df0 dftrt errcode) using complex_noint_mar1_2, replace
