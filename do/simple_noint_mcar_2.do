...
cap log close
log using simple_noint_mcar_2, smcl replace
...
tempname sim
postfile `sim' int(rep) str28(method) float(mcra mderiv b0 btrt se0 setrt df0 dftrt) using simple_noint_mcar_2, replace
